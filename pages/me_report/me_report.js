...
Page({
  ...
  initData: function (e) {
    ...
    wx.request({
      ...
      url: getApp().globalData.api.news.VehicleAccidents , //仅为示例，并非真实的接口地址
      method: 'POST',
      data: {
        status: 2,
      },
      ...
      success: function (res) {
        ...
        for (var i = 0; i < thisdata.length; i++) {
          thisdata[i].accidentTime = app.globalData.timestampToTime(thisdata[i].accidentTime); //时间转换
        }
